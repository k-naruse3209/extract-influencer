...
<p><small>Last updated: March 31, 2026</small></p>
...
<p>The Service provides tools for discovering, analyzing, and comparing Instagram influencer accounts. Features include profile data retrieval via the Instagram Graph API, scoring and analysis, candidate comparison, and report generation (PDF/CSV).</p>
...
<h2>5. Facebook and Instagram Integration</h2>
<p>The Service integrates with Facebook and Instagram via the Meta Platform APIs. By connecting your Facebook account, you agree to grant the Service permission to access your Facebook Pages and linked Instagram Business accounts, and to comply with Meta's Platform Terms.</p>
...
<p>This page explains how to request deletion of your data that DXAI Solutions, Inc. has collected through the Influencer Discovery Platform via Facebook Login.</p>

<h2>What Data We Store</h2>
<p>When you connect your Facebook account to our Service, we store:</p>
<ul>
...
<h3>Option 2: Revoke via Facebook</h3>
<ol>
<li>Go to your <a href="https://www.facebook.com/settings?tab=applications">Facebook Settings &gt; Apps and Websites</a></li>
...
<p><small>Last updated: March 24, 2026</small></p>
...
<h3>2.1 Information from Facebook and Instagram</h3>
<p>When you connect your Facebook account through Facebook Login, we access the following data with your explicit consent:</p>
<ul>
<li><strong>instagram_basic</strong>: Basic profile information of Instagram Business or Creator accounts linked to your Facebook Pages.</li>
<li><strong>pages_show_list</strong>: A list of Facebook Pages you manage.</li>
<li><strong>pages_read_engagement</strong>: Engagement data from your Facebook Pages.</li>
<li><strong>business_management</strong>: Access to business assets associated with your account.</li>
</ul>

<h3>2.2 Business Discovery Data</h3>
<p>We use the Instagram Business Discovery API to retrieve publicly available profile information of Instagram Business and Creator accounts for analysis purposes.</p>
...
<p>Access tokens obtained through Facebook Login are encrypted using AES-256-GCM before storage. We do not store plaintext tokens. All data is transmitted over HTTPS. We implement role-based access control (RBAC).</p>

<h2>5. Data Sharing</h2>
<p>We do not sell, trade, or rent your personal information to third parties. We do not share your Facebook or Instagram data with any third party.</p>
